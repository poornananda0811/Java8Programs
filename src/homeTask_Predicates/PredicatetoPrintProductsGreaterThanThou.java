...
public class PredicatetoPrintProductsGreaterThanThou {
	...
	public static void main(String[] args) {
		...
		Predicate<Product> i =(prod)->prod.price>1000;
		Product prod=productsList.get(new Random().nextInt(productsList.size()));
		System.out.println("The prod Name is---"+prod.name+ " prod price is"+prod.price);
