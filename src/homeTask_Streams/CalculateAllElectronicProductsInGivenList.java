...
public class CalculateAllElectronicProductsInGivenList {
	...
	public static void main(String[] args) {
		...
		System.out.println("Count of Electronic Products in the list is " + productsWithCategoryOfElectronics.size());
